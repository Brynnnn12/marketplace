            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <div id="status-indicator" class="mt-6 text-center">
                    <div class="inline-flex items-center text-sm text-gray-600">
                        <svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-yellow-600" xmlns="http://www.w3.org/2000/svg"
                    ...
                    statusCheckInterval = setInterval(() => {
                        ...
                        if (checkCount < 20) {
                            ...
                            document.getElementById('status-indicator').innerHTML =
                                '<div class="text-gray-600">Pemeriksaan otomatis dihentikan. Silakan periksa manual.</div>';
                        }
                    }, 15000);
